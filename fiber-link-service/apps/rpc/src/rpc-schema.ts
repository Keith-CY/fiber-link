...
const METHOD_SCHEMAS: Record<string, MethodSchemaEntry> = {
  ...
  "notification.channel.delete": {
    params: NotificationChannelDeleteParamsSchema,
    result: NotificationChannelDeleteResultSchema,
    description: "Disable (soft-delete) one of the authenticated app's notification channels.",
  },
  "notification.channel.test": {
    params: NotificationChannelTestParamsSchema,
    result: NotificationChannelTestResultSchema,
    description: "Send a synthetic TIP_SETTLED delivery to a channel and report whether it was accepted.",
  },
