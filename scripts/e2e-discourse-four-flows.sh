...
if [[ "${LIQUIDITY_FALLBACK_MODE}" == "channel_rotation" ]]; then
  export FIBER_WITHDRAWAL_CKB_LIQUIDITY_FEE_BUFFER="${FIBER_WITHDRAWAL_CKB_LIQUIDITY_FEE_BUFFER:-${E2E_WITHDRAWAL_LIQUIDITY_FEE_BUFFER_DEFAULT:-1}}"
  export FIBER_WITHDRAWAL_CKB_LIQUIDITY_POST_TX_RESERVE="${FIBER_WITHDRAWAL_CKB_LIQUIDITY_POST_TX_RESERVE:-${E2E_WITHDRAWAL_LIQUIDITY_POST_TX_RESERVE_DEFAULT:-0}}"
  export FIBER_WITHDRAWAL_CKB_LIQUIDITY_WARM_BUFFER="${FIBER_WITHDRAWAL_CKB_LIQUIDITY_WARM_BUFFER:-${E2E_WITHDRAWAL_LIQUIDITY_WARM_BUFFER_DEFAULT:-${WORKFLOW_WITHDRAW_AMOUNT:-61}}}"
  export FIBER_CHANNEL_ROTATION_BOOTSTRAP_RESERVE="${CHANNEL_ROTATION_BOOTSTRAP_RESERVE:-${FIBER_CHANNEL_ROTATION_BOOTSTRAP_RESERVE:-${WORKFLOW_WITHDRAW_AMOUNT:-61}}}"
  export FIBER_CHANNEL_ROTATION_MIN_RECOVERABLE_AMOUNT="${CHANNEL_ROTATION_MIN_RECOVERABLE_AMOUNT:-${FIBER_CHANNEL_ROTATION_MIN_RECOVERABLE_AMOUNT:-$(( ${WORKFLOW_WITHDRAW_AMOUNT:-61} + ${FIBER_WITHDRAWAL_CKB_LIQUIDITY_FEE_BUFFER} + ${FIBER_WITHDRAWAL_CKB_LIQUIDITY_POST_TX_RESERVE} + ${FIBER_WITHDRAWAL_CKB_LIQUIDITY_WARM_BUFFER} ))}}"
fi
persist_state_env
...
if [[ "${RUN_DOUBLE_WITHDRAWAL_REGRESSION}" -eq 1 ]]; then
  ...
  export E2E_WITHDRAWAL_SIGNER_RESERVE_TOPUP=0
  export E2E_WITHDRAWAL_SIGNER_TARGET_SHANNONS="${E2E_WITHDRAWAL_SIGNER_TARGET_SHANNONS:-6100000000}"
